...
require($global['confroot'].'/inc/handler_db.inc');
	...
	if ($result==false)
	{ daoErrorLog(__FILE__, __LINE__, __METHOD__, __CLASS__, __FUNCTION__, $global['db']->ErrorMsg(), "generate categry 1");
	}
	...
	if($type_name === false) 
	{ 
	daoErrorLog(__FILE__, __LINE__, __METHOD__, __CLASS__, __FUNCTION__, $global['db']->ErrorMsg(), "generate category 2");
	}
	...
	if($categories === false) 
	{ 
	daoErrorLog(__FILE__, __LINE__, __METHOD__, __CLASS__, __FUNCTION__, $global['db']->ErrorMsg(), "generate categry 3"); 
	}
